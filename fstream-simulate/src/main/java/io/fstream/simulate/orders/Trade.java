...
public class Trade {
	...
	public Trade(DateTime tradetime,IOrder active, IOrder passive,int executedsize) {
		this.setPrice(passive.getPrice());
		this.setSymbol(symbol);
		this.setTime(tradetime);; // use active orders timestamp as tradetime. Simplifying assumption
	...
	public String toString () {
		return String.format("%s,%s,%s,%s,%s", this.getBuyuser(),this.getSelluser(),this.isActivebuy(),this.getAmount(),this.getPrice());
