(function () {
   ...
   function alertsCtrl($scope, $filter, historyService) {
      ...
      function updateAlerts() {
         var params = {
            startTime: $scope.startTime && (moment($scope.startTime, "YYYY-MM-DD hh:mm:ss").valueOf() - 1) * 1000,
            endTime: $scope.endTime && moment($scope.endTime, "YYYY-MM-DD hh:mm:ss").valueOf() * 1000
         }
