...
import io.fstream.persist.parquet.BasicEventParquetWriter.Groups;
...
public class BasicEventParquetWriter implements EventParquetWriter {
  ...
  public BasicEventParquetWriter(@NonNull EventType type, @NonNull Path outputFile) {
    this.type = type;
